...
import { PanelContainer, ScrollContainer, Space, Button, TextLink, Box, Icon, Alert } from '@grafana/ui';
...
export class Installer extends PureComponent<InstallerProps, State> {
  constructor(props: InstallerProps) {
    super(props);
    this.state = {
      dds: {
      ...
      <ScrollContainer>
        ...
        <PanelContainer style={{ border: 'none' }}>
          <Alert title="What happens when I click 'Install Dashboards'?" severity="info" style={{ margin: '0' }}>
            ...
            <br />
            If the folder exists, the dashboards are considered as already installed.
          </Alert>
        </PanelContainer>
